  ...
  return (
    <div className='bg-gray pb-9 mt-5 px-4 sm:px-6 lg:px-2'>
      ...
      <div className="flex flex-wrap justify-center space-x-2 text-lg mt-5">
        <button className='text-white border border-yellow-500 p-1 px-5 mb-2 sm:mb-0 hover:bg-amber-600 duration-200'>Home</button>
        <button className='text-white border border-yellow-500 p-1 px-5 mb-2 sm:mb-0 hover:bg-amber-600 duration-200'>About</button>
        <button className='text-white border border-yellow-500 p-1 px-5 mb-2 sm:mb-0 hover:bg-amber-600 duration-200'>Menu</button>
        <button className='text-white border border-yellow-500 p-1 px-5 mb-2 sm:mb-0 hover:bg-amber-600 duration-200'>Products</button>
        <button className='text-white border border-yellow-500 p-1 px-5 mb-2 sm:mb-0 hover:bg-amber-600 duration-200'>Reviews</button>
        <button className='text-white border border-yellow-500 p-1 px-5 mb-2 sm:mb-0 hover:bg-amber-600 duration-200'>Contact</button>
        <button className='text-white border border-yellow-500 p-1 px-5 mb-2 sm:mb-0 hover:bg-amber-600 duration-200'>Blogs</button>
      </div>
