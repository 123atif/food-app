        ...
        <div className="flex items-start justify-center gap-12">
          ...
          <form className="text-center m-10 mt-28">
            <div className="flex items-center mb-8 ml-[-22rem]">
              ...
              <input type="text" placeholder='name' className='bg-gray-900 h-15 border-solid border-2 border-yellow-500 w-full text-white hover:bg-white hover:text-gray-900 p-3' />
            </div>
            <div className="flex items-center mb-8 ml-[-22rem]">
              <FontAwesomeIcon icon={faEnvelope} className='text-white mr-3'/>
              <input type="text" placeholder='email' className='bg-gray-900 h-15 border-solid border-2 border-yellow-500 w-full text-white hover:bg-white hover:text-gray-900 p-3' />
            </div>
            <div className="flex items-center mb-8 ml-[-22rem]">
              <FontAwesomeIcon icon={faPhone} className='text-white mr-3'/>
              <input type="number" placeholder='number' className='bg-gray-900 h-15 border-solid border-2 border-yellow-500 w-full text-white hover:bg-white hover:text-gray-900 p-3' />
            </div>
