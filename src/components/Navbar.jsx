		...
		<div className="fixed top-0 bg-black border-yellow-500 border-b-2 z-30 w-full flex justify-between items-center px-6 lg:px-24 py-2">
			...
			<div className="flex gap-4">
              ...
              setClick(false)
					...
					/>
					{sidebarOpen && (
						<div className={`flex flex-col fixed top-[87px] right-0 z-20 w-[350px] duration-300 h-[calc(100vh-80px)]
						 overflow-x-hidden overflow-y-auto text-black bg-white ${show && 'hidden'}`}>
							{menuList.map((item) => (
